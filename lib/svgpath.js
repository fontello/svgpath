  ...
  this.iterate(function (s, index, x, y) {
    ...
    switch (s[0]) {
      ...
      case 'A':
        ...
        result[3] = ((s[3] + angle) % 360 + 360) % 360;
...
SvgPath.prototype.unshort = function () {
  var segments = this.segments;
  var prevControlX, prevControlY, prevCmd;
  ...
  this.iterate(function (s, idx, x, y) {
    ...
    if (name === 'T') { // qubic curve
      s[0] = 'Q';
      prevCmd = segments[idx - 1][0];
      prevControlX = prevCmd === 'Q' ? segments[idx - 1][1] : x;
      prevControlY = prevCmd === 'Q' ? segments[idx - 1][2] : y;
      curControlX = 2 * x - prevControlX;
      curControlY = 2 * y - prevControlY;
      segments[idx] = [
        s[0],
      ...
      s[0] = 'C';
      prevCmd = segments[idx - 1][0];
      prevControlX = prevCmd === 'C' ? segments[idx - 1][3] : x;
      prevControlY = prevCmd === 'C' ? segments[idx - 1][4] : y;
      curControlX = 2 * x - prevControlX;
      curControlY = 2 * y - prevControlY;
      segments[idx] = [
        s[0],
