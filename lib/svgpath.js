...
function SvgPath(path) {
  ...
  // The current transform (identity at the begining)
  this.affineTransform  = affineTransform();
}


SvgPath.prototype.__transform = function (m) {
  var self = this,
...
//
SvgPath.prototype.applyTransform = function () {
  if (this.affineTransform.isIdentity()) { return this; }

  this.__transform(this.affineTransform);
